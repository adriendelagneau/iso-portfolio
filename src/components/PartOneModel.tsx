    ...
    <group {...props} dispose={null}>
      ...
      <group position={[-4.334, 2.321, 8.025]} rotation={[-Math.PI, 1.566, -Math.PI]} scale={4.152}>
        ...
        <mesh
          ...
          material={bakedMaterial}
          position={[0.006, 0.022, -0.006]}
        />
        <mesh
          geometry={nodes.FloroLamp_WirePlug.geometry}
          material={bakedMaterial}
          position={[0.042, 0.177, -0.196]}
        />
      </group>
      <group position={[-3.256, 2.325, 3.226]} rotation={[-Math.PI / 2, 0, 1.567]} scale={0.006}>
        <group rotation={[Math.PI / 2, 0, 0]}>
          <group position={[516.027, -370.667, 517.222]} rotation={[0, -1.567, 0]} scale={159.394}>
            <mesh
              geometry={nodes.pasted__sofalegs_pasted__sofalegsShape_bakedmtl2_0.geometry}
              material={bakedMaterial}
              position={[5.851, 5.541, 8.098]}
            />
          </group>
          <mesh
            geometry={nodes.pasted__sodametals_pasted__coopermat1_0.geometry}
            material={bakedMaterial}
            position={[-0.084, -4.267, -44.043]}
            rotation={[-Math.PI / 2, 0, 0]}
            scale={0.5}
          />
          <mesh
            geometry={nodes.pasted__sofabody2_pasted__sofabody2Shape_bakedmtl2_0001.geometry}
            material={bakedMaterial}
            position={[0, -4.267, 0]}
          />
          <mesh
            geometry={nodes.pasted__sofabuttons_pasted__buttonsmat1_0001.geometry}
            material={bakedMaterial}
            position={[0, -4.267, 0]}
            scale={5}
          />
      ...
      <mesh
        ...
        material={bakedMaterial}
        position={[-2.154, 8.289, -4.501]}
        rotation={[0, 0.778, 0]}
        scale={1.829}
      />
      <mesh
        geometry={nodes.Yucca_plant.geometry}
        material={bakedMaterial}
        position={[-3.98, 2.326, -3.195]}
